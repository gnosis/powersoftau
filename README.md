...
```bash
 ...
 docker run -it -v ~/.ssh/:/root/.ssh -e CONSTRAINED=true -e KEY_GITTER_TRUSTED_SETUP_ROOM=2ae0b8adf55e84b3bd41 -e DATEOFNEWESTCONTRIBUTION=1 -e TRUSTEDSETUPTURN=1 -e MAKEFIRSTCONTRIBUTION=yes valdiation_worker  bash 
```
