...
```bash
 ...
 docker run -it -v ~/.ssh/:/root/.ssh -e CONSTRAINED=true -e KEY_GITTER_TRUSTED_SETUP_ROOM=<key> -e DATE_OF_NEWEST_CONTRIBUTION=1 -e TRUSTED_SETUP_TURN=1 -e MAKEFIRSTCONTRIBUTION=yes valdiation_worker  bash 
```
